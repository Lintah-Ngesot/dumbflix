...
function DetailFilm () {
  ...
  return (
    ...
    {/* <NavbarAdmin/> */}
      <Container>
      <Card border="dark">
        <Card.Img variant="top" src={images.detailfilm1} style={{borderRadius:'0px', height: '536px', objectFit: 'cover'}} />
      </Card><br></br>
      <Button variant='danger' style={{float: 'right'}} onClick={handleShowAdd}>Add Episode</Button><br/><br/><br/>
      </Container>

      <Container fluid style={{marginLeft: '87px'}}>
